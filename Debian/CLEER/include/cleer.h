...
std::string getKeyboardInput() {
    std::string input;
    char c = std::cin.get();  // Legge il primo carattere disponibile

    if (c == '\033') {  // Controllo se il carattere è un escape character
        // Legge i due caratteri successivi che rappresentano una freccia
...
// definizione funzioni di cleer.cpp


// definizione funzioni templates
